...
class RedisPipeQueue(RedisQueue):
    ...
    def add_values(self, values):
        ...
        bytes_added = 0
        call_cnt = 0
        value_len = len(values[0]) # currently all values should be same length
        for value in values:
